...
const PurchaseHistory = () => {
    ...
    const formatPrice = (price) => money(price);
                                ...
                                >
                                    ...
                                    <div className="order-amount">
                                        ...
                                        {order.shippingProvider === "GHN" && (
                                            <span className="status-badge confirmed" style={{ fontSize: '0.65rem', padding: '2px 6px' }}>GHN</span>
                                        )}
                                        ...
                                        <div className="order-details-section">
                                            ...
                                            <div className="details-grid">
                                                ...
                                                <div className="detail-item">
                                                    ...
                                                    <span className="detail-value">{formatPrice(order.subTotal)}</span>
                                                </div>
                                                {order.discountAmount > 0 && (
                                                    <div className="detail-item">
                                                        <span className="detail-label">Giảm giá:</span>
                                                        <span className="detail-value" style={{ color: '#52c41a' }}>-{formatPrice(order.discountAmount)}</span>
                                                    </div>
                                                )}
                                                {order.shippingFee > 0 && (
                                                    <div className="detail-item">
                                                        <span className="detail-label">Phí vận chuyển:</span>
                                                        <span className="detail-value">{formatPrice(order.shippingFee)}</span>
                                                    </div>
                                                )}
                                                {order.shippingFee === 0 && order.shippingProvider && (
                                                    <div className="detail-item">
                                                        <span className="detail-label">Phí vận chuyển:</span>
                                                        <span className="detail-value" style={{ color: '#52c41a' }}>Miễn phí</span>
                                                    </div>
                                                )}
                                                {order.shippingOrderCode && (
                                                    <div className="detail-item">
                                                        <span className="detail-label">Mã vận đơn:</span>
                                                        <span>{order.shippingOrderCode}</span>
                                                    </div>
                                                )}
                                                ...
                                                {order.shippingProvider === "GHN" && (
                                                    <div className="detail-item">
                                                        ...
                                                        <span className="status-badge confirmed" style={{ fontSize: '0.7rem', padding: '2px 8px' }}>Giao Hàng Nhanh</span>
                                                    </div>
                                                )}
                                                <div className="detail-item">
                                                    <span className="detail-label" style={{ fontWeight: 'bold' }}>Tổng thanh toán:</span>
                                                    <span className="detail-value" style={{ fontWeight: 'bold', color: '#ff4d4f' }}>{formatPrice(order.total)}</span>
                                                </div>
                                            </div>
                                        </div>
